...
par(mfcol = c(2,2), mar = c(5, 5, 5, 1), oma = c(0, 0, 0, 0))
with(powerData2, plot((strptime(datetime, "%d/%m/%Y %H:%M:%S")) , Global_active_power, type="l", ylab="Global Active Power" , xlab="" ) )
...
with(powerData2, plot((strptime(datetime, "%d/%m/%Y %H:%M:%S")) , Voltage, type="l", ylab="Voltage" , xlab="datetime" ) )

with(powerData2, plot((strptime(datetime, "%d/%m/%Y %H:%M:%S")) , Global_reactive_power, type="l", ylab="Global_reactive_power" , xlab="datetime" ) )
